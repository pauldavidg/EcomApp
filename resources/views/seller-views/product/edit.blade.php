                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <center>
                                    ...
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"" alt="Product thumbnail"/>
                                </center>
                            </div>
                        </div>
                    </div>
...
@push('script')
    ...
    {{--    <script src="{{asset('public/assets/back-end')}}/js/bootstrap-select.min.js"></script>--}}
