...
<div class="content container-fluid">
    ...
    <div class="row" style="padding-bottom: 20px">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body" style="padding: 20px">
                    <form action="{{route('admin.business-settings.web-config.sales-commission')}}"
                          method="post">
                        @csrf
                        <label>Sales Commission ( % )</label>
                        <input class="form-control" name="commission" value="{{isset($commission)?$commission->value:0}}"
                               min="0" max="100">
                        <hr>
                        <button type="submit"
                                class="btn btn-primary float-right ml-3">{{trans('messages.Save')}}</button>
